...
<body class="bootstrap-admin-with-small-navbar">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-2 bootstrap-admin-col-left">
				...
				<ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
					<li><a href="/books/admin_log.jsp"><i
						...
						<table id="data_list" class="table table-hover table-bordered"
							...
							<tbody>
								...
								<td><button type="button" class="btn btn-warning btn-xs"
										onclick="haibook(<%=bean.getHid()%>,<%=bean.getCard()%>,'<%=bean.getEndtime()%> 00:00:00',<%=bean.getBid()%>,<%=bean.getAid()%>)">还书</button>
    ...
    function haibook(hid,card,endTime,bid,aid) {
    	...
    	if(con==true){
    		...
    		location.href = "/books/borrowServlet?tip=2&show=2&hid="+hid+"&card="+card+"&endTime="+endTime+"&bid="+bid+"&aid="+aid;
